...
def gene_set_covariance(
    ...
    gene_sets: dict,
    varm_key: str,
    plot: Union[bool, Sequence[str]] = False,  # now accepts list of names
    ...
    for set_name, genes in gene_sets.items():
        ...
        temp_df = pd.DataFrame({
            "gene_set": set_name,
            "embedding_dimension": cov_matrix.columns,
    ...
    if do_plot and plot_payload:
        ...
        for i, payload in enumerate(plot_payload):
            ...
            ax.axvline(x=cutoff_dim * 2, linestyle="--", linewidth=1, color="red",
